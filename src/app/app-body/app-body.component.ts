...
export class AppBodyComponent implements OnInit {
  ...
  addStockToPortfolio(stock: Stock): void {
    this.gridView.push(stock)

    let index = this.addStocks.indexOf(stock);
    this.addStocks.splice(index, 1)
  }

  removeStockFromPortfolio(): void {
    this.gridView = this.gridView.filter(e => e.symbol !== this.selectedRows[0])
    this.addStocks.push(this.deletedStock)
  }
  ...
  handleSelectionChange(event: SelectionEvent): void {
    this.deletedStock = event.selectedRows[0].dataItem;
  }
